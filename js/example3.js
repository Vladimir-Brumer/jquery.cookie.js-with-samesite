...
/*example 3:*/
	...
	/*если печенька есть то обращаемся к button с идентификаторвом равным этому значению и добавляем этой кнопке класс «ActiveScheme». тегу html добавляем класс со значением печеньки*/
